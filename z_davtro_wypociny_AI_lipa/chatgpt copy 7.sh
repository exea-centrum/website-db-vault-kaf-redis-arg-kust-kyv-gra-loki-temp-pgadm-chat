...
REGISTRY="ghcr.io/$(gh api user --jq .login)/${PROJECT}"
REPO_URL="https://github.com/$(gh api user --jq .login)/${PROJECT}.git"
...
echo "=== 2. FastAPI (main.py) – krótki, ale kompletny ==="
cat > "${APP_DIR}/main.py" <<'PY'
from fastapi import FastAPI, Form, Request, HTTPResponse
